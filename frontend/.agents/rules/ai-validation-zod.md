...
1. **Intercepción y Sanitización de Bloques de Código:**
   - Usar `safeParseAIResponse` de [`frontend/shared/lib/ai/safe-ai-parser.ts`](file:///c:/Users/JoseO/OneDrive/Documentos/proyectos/next15-fastapi-supabase-template/frontend/shared/lib/ai/safe-ai-parser.ts).
